...
def batch_binary_metric_calculation(llm_answers_batch, scores, y_amb_type_batch, y_amb_intents_batch,
                                    y_amb_shortlist_batch):
    metrics_batch = {'llm_answers': [], 'scores': [], 'y_amb_type': [], 'y_amb_intents': [], 'y_amb_shortlist': [],
...
def aggreate(metrics_batch):
    ...
    for ambiguity_type in ambiguity_types:
        ...
        metrics_li.append({'ambiguity_type': ambiguity_type, 'sr_agg': sr, 'amb_detection_agg': amb_detection,
                           'help_rate_agg': help_rate, 'ssc_agg': ssc})
    return metrics_li
...
def nohelp_aggreate(metrics_batch):
    ...
    for ambiguity_type in ambiguity_types:
        ...
        metrics_li.append(
            {'ambiguity_type': ambiguity_type, 'sr_agg': sr, 'correct_help_rate_detection_agg': amb_detection,
             'help_rate_agg': help_rate})
    return metrics_li
